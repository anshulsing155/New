...
<section class=" bg-white">
    <div class=" container m-auto px-8">
        <div class="grid lg:grid-cols-2 ">
            ...
            <p
                class=" text-right text-2xl font-medium pr-8 lg:mt-8 mt-2 "
                id="menu-button"
            >
        ...
        <div class="grid lg:grid-cols-2 ">
            <div class="  px-12">
                ...
                <iframe class="w-full lg:h-96 h-60" src="https://www.youtube.com/embed/Lk2oDvoonUc?si=8fjISpKa-5U3Ck6X">hii</iframe>
            </div>
