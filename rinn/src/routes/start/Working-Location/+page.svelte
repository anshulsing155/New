...
<section class="sm:w-1/3 px-20 m-auto mb-10">
    ...
    <select
        ...
        class="mb-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:text-white "
    >
