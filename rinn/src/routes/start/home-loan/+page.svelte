...
<div class="flex items-center justify-center mb-20">
    <form class="w-full max-w-screen-sm" id="form" method="Post">
        ...
        <div class="m-10">
            ...
            >
                <span class="my-auto flex"
                    ><svg height="36px" width="36px" stroke="#017848" viewBox="0 0 36 36" aria-hidden="true" fill="#017848" version="1.1" xmlns="http://www.w3.org/2000/svg" style="margin-left: 16px; margin-right: 12px;"><path d="M35.5788 13.7471L18.7031 0.246849C18.5037 0.0868839 18.2556 0 17.9999 0C17.7445 0 17.4964 0.0868903 17.2967 0.246849L0.420977 13.7471C0.177889 13.9422 0.0264575 14.2295 0.00310143 14.5404C-0.0200026 14.8516 0.0867283 15.1582 0.298173 15.3875C0.509625 15.6167 0.806708 15.7478 1.11862 15.7496H3.36872V34.875C3.36872 35.1733 3.48726 35.4596 3.6982 35.6705C3.90914 35.8815 4.19543 36 4.49377 36H31.495C31.7933 36 32.0796 35.8815 32.2905 35.6705C32.5015 35.4596 32.62 35.1733 32.62 34.875V15.7496H34.8701C35.1833 15.7508 35.4829 15.6218 35.6965 15.393C35.9105 15.1642 36.0195 14.8566 35.9971 14.5442C35.9748 14.2318 35.8231 13.943 35.5788 13.7472L35.5788 13.7471ZM31.495 13.4995C31.1967 13.4995 30.9104 13.618 30.6995 13.829C30.4885 14.0399 30.37 14.3262 30.37 14.6245V33.7499H5.6189V14.6245C5.6189 14.3262 5.50036 14.0399 5.28942 13.829C5.07847 13.618 4.79219 13.4995 4.49385 13.4995H4.32509L17.9941 2.56429L31.6631 13.4995H31.495Z" fill="#017848"></path><path d="M14.5 21H21.5" stroke="#017848" stroke-linecap="round" stroke-width="2"></path><path d="M14.5 24H21.5" stroke="#017848" stroke-linecap="round" stroke-width="2"></path><path d="M14.5 27H21.5" stroke="#017848" stroke-linecap="round" stroke-width="2"></path><path clip-rule="evenodd" d="M12 11H20L26 17V29C26 30.1 25.1 31 24 31H11.99C10.89 31 10 30.1 10 29L10.01 13C10.01 11.9 10.9 11 12 11ZM12 13V29H24V18H19V13H12Z" fill="#017848" fill-rule="evenodd"></path></svg></span
                >
                <p class="text-lg flex mx-4 my-auto">Property Finalised but Agreement is not signed. Need
                    Sanction Letter to see eligiblity ( Validity 3 months)</p>
            </label>
        </div>
        <div class="m-10">
            <input
            ...
            >
                <span class="my-auto flex"
                    >
                    <svg height="36px" width="36px" stroke="none" viewBox="0 0 36 37" aria-hidden="true" fill="none" version="1.1" xmlns="http://www.w3.org/2000/svg" style="margin-left: 16px; margin-right: 12px;"><path d="M35.5788 13.7471L18.7031 0.246849C18.5037 0.0868839 18.2556 0 17.9999 0C17.7445 0 17.4964 0.0868903 17.2967 0.246849L0.420977 13.7471C0.177889 13.9422 0.0264575 14.2295 0.00310143 14.5404C-0.0200026 14.8516 0.0867283 15.1582 0.298173 15.3875C0.509625 15.6167 0.806708 15.7478 1.11862 15.7496H3.36872V34.875C3.36872 35.1733 3.48726 35.4596 3.6982 35.6705C3.90914 35.8815 4.19543 36 4.49377 36H31.495C31.7933 36 32.0796 35.8815 32.2905 35.6705C32.5015 35.4596 32.62 35.1733 32.62 34.875V15.7496H34.8701C35.1833 15.7508 35.4829 15.6218 35.6965 15.393C35.9105 15.1642 36.0195 14.8566 35.9971 14.5442C35.9748 14.2318 35.8231 13.943 35.5788 13.7472L35.5788 13.7471ZM31.495 13.4995C31.1967 13.4995 30.9104 13.618 30.6995 13.829C30.4885 14.0399 30.37 14.3262 30.37 14.6245V33.7499H5.6189V14.6245C5.6189 14.3262 5.50036 14.0399 5.28942 13.829C5.07847 13.618 4.79219 13.4995 4.49385 13.4995H4.32509L17.9941 2.56429L31.6631 13.4995H31.495Z" fill="#017848"></path><path d="M28.3945 31.999H8.39453V35.999H28.3945V31.999Z" fill="#fffdfa"></path><path d="M19.2258 16.0019C19.2112 16.005 19.1966 16.0095 19.1821 16.0141L11.7154 17.9549C11.5204 18.008 11.391 18.1611 11.3946 18.331V33.8578C11.3946 34.0353 11.5386 34.1899 11.7446 34.2339L19.2112 35.7866C19.3516 35.8169 19.4993 35.7911 19.6141 35.7168C19.7271 35.644 19.7946 35.5303 19.7946 35.4105V16.3901C19.7964 16.2779 19.7381 16.1718 19.6378 16.0975C19.5375 16.0232 19.4026 15.9883 19.2696 16.0019C19.255 16.0019 19.2404 16.0019 19.2258 16.0019ZM18.8612 16.9238V34.9132L12.3279 33.5546V18.6221L18.8612 16.9238ZM20.7279 17.5546V18.331H24.4612V33.4697H20.7279V34.246H24.9279C25.1849 34.246 25.3945 34.0716 25.3945 33.8578V17.9428C25.3945 17.729 25.1849 17.5546 24.9279 17.5546H20.7279Z" fill="#017848" stroke="#017848"></path><path d="M16.2944 25.8989V27.5489" stroke="#017848" stroke-linecap="round" stroke-width="2"></path></svg></span
                >
                <p class="text-lg flex mx-4 my-auto">Need only Sanction letter (Validity 3 months)</p>
            </label>
        </div>
    </form>
</div>
